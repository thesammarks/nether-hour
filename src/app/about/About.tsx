            ...
            <div className={styles.section}>
                ...
                <div className={styles.imageRow}>
                    ...
                    <Image
                        className={styles.image}
                        width={1} height={1}
                        src={"/images/about/img04.jpg"}
                        alt="About Image 04"
                    />
                    <Image
                        className={`${styles.image} ${styles.hiddenLg}`}
                        width={1} height={1}
                        src={"/images/about/img05.jpg"}
                        alt="About Image 05"
                    />
                </div>
            </div>
            ...
            <div className={styles.section}>
                ...
                <div className={styles.imageRow}>
                    <Image
                        className={styles.image}
                        width={1} height={1}
                        src={"/images/about/img06.jpg"}
                        alt="About Image 06"
                    />
                    <Image
                        className={styles.image}
                        width={1} height={1}
                        src={"/images/about/img07.jpg"}
                        alt="About Image 07"
                    />
                    <Image
                        className={`${styles.image} ${styles.hiddenLg}`}
            ...
            <div className={styles.section}>
                ...
                <div className={styles.imageRow}>
                    <Image
                        className={styles.image}
                        width={1} height={1}
                        src={"/images/about/img11.jpg"}
                        alt="About Image 11"
                    />
                    <Image
                        className={styles.image}
                        width={1} height={1}
                        src={"/images/about/img12.jpg"}
                        alt="About Image 12"
                    />
                    <Image
                        className={styles.image}
                        width={1} height={1}
                        src={"/images/about/img13.jpg"}
                        alt="About Image 13"
                    />
                </div>
            </div>
